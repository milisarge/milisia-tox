...
class Tox:
    ...
    def self_set_status_message(self, status_message):
        ...
        """
        tox_err_set_info = c_int()
        result = Tox.libtoxcore.tox_self_set_status_message(self._tox_pointer, c_char_p(str.encode(status_message)),
    ...
    def friend_add(self, address, message):
        ...
        result = Tox.libtoxcore.tox_friend_add(self._tox_pointer, string_to_bin(str.encode(address)), c_char_p(message),
